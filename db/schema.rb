...
ActiveRecord::Schema[7.0].define(version: 2022_07_08_131929) do
  ...
  create_table "generic_services", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_generic_services_on_category_id"
  end
  ...
  add_foreign_key "generic_services", "categories"
